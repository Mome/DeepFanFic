...
from fanficfare.htmlcleanup import removeEntities, removeAllEntities, stripHTML
...
class BaseStoryWriter(Configurable):
    ...
    def writeStory(self, outstream=None, metaonly=False, outfilename=None, forceOverwrite=False, outpath=None):
        print('write story !!!')
        self.metaonly = metaonly
        if outfilename == None:
            outfilename=self.getOutputFileName()
            outfilename=outpath + '/' + change_filename(outfilename)
